...
import { Moon, Sun, Search, Menu, BookOpen, PenTool, MessageSquare, Home, User, LogOut, BookMarked, MessageCircle, Library } from "lucide-react";
...
const navLinks = [
  ...
  { href: "/da",       label: "DA",       icon: BookMarked },
];
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur-sm">
      <nav className="mx-auto flex h-14 max-w-7xl items-center gap-3 px-3 sm:px-6">
        ...
        <div className="hidden md:flex items-center gap-1 ml-auto">
          ...
          {user && (
            <>
              <Link href="/bibliotheque" aria-label="Ma bibliothèque"
